...
<div class="row">
<div class="col-md-10">
<form class="form-horizontal" method="post" action="php echo $base_url ?>?r=adduser">
...
<div class="col-md-8">
<input type="text" class="form-control" value="" name="FirstName"  placeholder="Enter firstname" required>
</div>
</div>
<div class="form-group">
<label class="col-md-4 control-label">Last Name</label>
<div class="col-md-8">
<input type="text" class="form-control" value="" name="LastName"  placeholder="Enter lastname" required>
</div>
</div>
<div class="form-group">
<label class="col-md-4 control-label">Phone Number</label>
<div class="col-md-8">
<input type="text" class="form-control" value="" name="PhoneNumber"  placeholder="Enter lastname" required>
</div>
</div>
...
<div class="col-md-8">
<input type="file" class="form-control" value="" name="fileToUpload"  placeholder="Enter lastname" >
</div>
</div>
...
<input type="submit" name="SIGNUP" value="SIGN UP" class="btn btn-success" />
 ...
 -->
                ...
                <div class="myborder">
                <form class="form-horizantal" method="post" enctype="multipart/form-data" action="<?php echo $base_url;?>?r=adduser">
                     Email<input type="text" class="form-control" name="Email" placeholder="Enter user email"  autofocus><br>
